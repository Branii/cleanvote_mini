      ...
      <ul  id="sidebarnav" class="text-gray-600 text-sm">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500" href="report.php"
           >
            <i class="ti ti-file-description  text-xl"></i> <span>Veiw Results</span>
          </a>
        </li> 
                        ...
                        <div class="card overflow-hidden">
                          <div class="position-relative">
                            ...
                            <div class="progress-outer">
                              <div class="progress">
                                <?php  
                                $percent = $item['candidate_vote_count'] / 1000 * 100;
                                ?>
                                  <div class="progress-bar progress-bar-info progress-bar-striped active" style="width:<?=$percent?>%; box-shadow:-1px 10px 10px rgba(91, 192, 222, 0.7);"></div>
